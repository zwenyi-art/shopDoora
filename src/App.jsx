...
const App = () => {
  ...
  return (
    <>
      {show && (
        <div className="w-full z-50 h-screen transition-all duration-75 ease-in bg-black/60 fixed top-0 flex items-center justify-center">
          <div role="status">
            <svg
              aria-hidden="true"
      ...
      )}
      {
        <div
          className={`${
            show
              ? " overflow-hidden max-w-sm h-screen mx-auto container flex flex-col "
              : "max-w-sm h-full mx-auto container flex flex-col"
          }`}
        >
          <Navbar></Navbar>
          <Hero></Hero>
