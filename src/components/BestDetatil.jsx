...
const BestDetatil = () => {
  const [view_more, setViewMore] = useState(false);
  return (
    <>
      <div className="px-3 py-2 grid grid-cols-2 grid-rows-2 gap-2">
        <div className="flex flex-col items-center justify-center w-full h-full">
          <div className="bg-[#eaeaea] rounded-lg w-full h-full flex flex-col items-center justify-center ">
            ...
            <div className="pt-3">
              <img src={box1} alt="" className="w-fit h-[130px]" />
            </div>
          </div>
        ...
        <div className="flex flex-col items-center justify-center w-full h-full">
              <div className="bg-[#eaeaea] rounded-lg w-full h-full flex flex-col items-center justify-center ">
                ...
                <div className="pt-3">
                  <img src={box5} alt="" className="w-fit h-[130px]" />
                </div>
              </div>
              <div className="pt-3 w-full h-full text-center flex flex-col items-center">
                <h1 className="text-base">Refreshing Mint</h1>
        ...
        <div className="flex flex-col items-center justify-center w-full h-full">
          <div className="bg-[#eaeaea] rounded-lg w-full h-full flex flex-col items-center justify-center ">
            ...
            <div className="pt-3">
              <img src={box3} alt="" className="w-fit h-[130px]" />
            </div>
          </div>
          <div className="pt-3 w-full h-full text-center flex flex-col items-center">
            <h1 className="text-base">Refreshing Mint</h1>
        ...
        <div className="flex flex-col items-center justify-center w-full h-full">
          <div className="bg-[#eaeaea] rounded-lg w-full h-full flex flex-col items-center justify-center ">
            ...
            <div className="pt-3">
              <img src={box4} alt="" className="w-fit h-[130px]" />
            </div>
          </div>
          <div className="pt-3 w-full h-full text-center flex flex-col items-center">
            <h1 className="text-base">Refreshing Mint</h1>
        ...
        {view_more && (
          ...
          <div className="bg-[#eaeaea] rounded-lg w-full h-full flex flex-col items-center justify-center ">
            ...
            <div className="pt-3">
              <img src={box2} alt="" className="w-fit h-[130px]" />
            </div>
          </div>
          <div className="pt-3 w-full h-full text-center flex flex-col items-center">
            <h1 className="text-base">Refreshing Mint</h1>
            ...
            <div className="flex flex-col items-center justify-center w-full h-full">
              <div className="bg-[#eaeaea] rounded-lg w-full h-full flex flex-col items-center justify-center ">
                ...
                <div className="pt-3">
                  <img src={box6} alt="" className="w-fit h-[130px]" />
                </div>
              </div>
              <div className="pt-3 w-full h-full text-center flex flex-col items-center">
                <h1 className="text-base">Refreshing Mint</h1>
      ...
      <div className="pb-4 w-full pt-3 h-full flex items-center justify-center">
        <button
          ...
          className="rounded-full bg-black/10 px-10 py-1 text-center w-fit   font-bold text-black  flex items-center justify-between gap-x-4"
        >
          View More
